...
var FamilyMemberComponent = (function () {
    function FamilyMemberComponent(memberService) {
...
FamilyMemberComponent = __decorate([
    core_1.Component({
        ...
        template: "<h2>My Famile Members</h2>\n               <ul class=\"heroes\">\n               <li *ngFor=\"let member of families\" (click)=\"onSelect(member)\" [class.selected]=\"member === selectedMember\">\n                   <span class=\"badge\">{{member.id}}</span> {{member.name}}\n               </li>\n               </ul>\n               <member-detail [member]=\"selectedMember\"></member-detail>",
